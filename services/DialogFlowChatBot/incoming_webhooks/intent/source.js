...
exports = function(payload, response) {
  ...
  if (typeof item_size != "undefined" && item_size.length> 0) {
    //query.size = item_size;
    query.sizes =  item_size
  }
  ...
  products.findOne(query).then(productFound => {
      ...
      if (typeof productFound.color != "undefined") {
        ...
        product_data.fulfillmentText = "I found you a " 
                                      + productFound.color
                                      + " " + productFound.name 
                                      + ". Check it out here: https://eloquent-edison-9d2a63.netlify.com/products/" + productFound.id ;
        product_data.fulfillmentMessages = [
          {
            "card": {
              "title": productFound.name,
              "subtitle": "I found you a " + productFound.color + " " + productFound.name,
              "imageUri": "https://eloquent-edison-9d2a63.netlify.com/" + productFound.image.large,
              "buttons": [
                {
                  "text": "Buy Now",
                  "postback": "https://eloquent-edison-9d2a63.netlify.com/products/" + productFound.id
                }
              ]
            }
          }
