  ...
  let inStockNotif = function(user, product){
    ...
    .then(() => {
      return twilio.send({
        ...
        body: `Hi ${user.firstname}!  We wanted to let you know that ${product.name} is back in stock.  We have added it to your cart at https://eloquent-edison-9d2a63.netlify.com/cart` 
      });
    })
    .then(() => {
